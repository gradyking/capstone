...
write_tsv(summaryCLIP_x_table, "0_2_stoilov_microRNA_seed_mapping_with_genomic_locations/stoilovFinalComparisonTable.tsv")
...
ggplot( aes(x = regulation, y = distance)) + geom_violin() + labs(x = "AGO2 Regulation", y="Distance Between Closest AGO2/Msi-1 Pair") + theme_minimal()
  #+ ylim(-500,500)
ggsave("0_2_stoilov_microRNA_seed_mapping_with_genomic_locations/varianceLower.svg")
...
# is the notregulated distribution similar to a uniformly random distribution on the given strands?
